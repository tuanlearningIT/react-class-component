                    ...
                    <div className='home-header-content'>
                        <div className='left-content'>
                            <div className='logo' onClick={() => this.handlePushHome()}>
                                <div onClick={() => this.handlePushHome()}>TUAN DOCTOR CARE</div>
                            </div>
                        </div>
                        <div className='center-content'>
                            <div className='child-content' onClick={() => this.handleSpecialty()} >
                            ...
                            <div className='child-content' onClick={() => this.handleDoctor()}>
                                <div><b><FormattedMessage id="homeheader.doctor" /></b>
                        ...
                        <>
                            <div className='content-up' >
                                <div className='content-title'>
                                    <div className='title1'><h1><FormattedMessage id="banner.title1" />
                                    </h1></div>
                                    <div className='title2'><h1><b><FormattedMessage id="banner.title2" /> </b></h1></div>
