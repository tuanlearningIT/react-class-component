                    ...
                    <div className='medicalfacility-body'>
                        {
                            ...
                            dataClinic.map((item, index) => {
                                return (
                                    <>
                                        <div className='section-customize' key={index} onClick={() => this.handleDetaitClinic(item)}>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ClinicNew));
