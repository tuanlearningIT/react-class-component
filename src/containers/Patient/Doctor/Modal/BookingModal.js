                    ...
                    >
                        <div className='booking-modal-content'>
                            <div className='booking-modal-header'>
                                <span className='left'><FormattedMessage id="patient.booking-modal.intro" /></span>
                            ...
                            <div className='booking-modal-body'>
                                ...
                                <div className='row'>
                                    <div className='col-6 form-group'>
                                        ...
                                        <input className='form-control' onChange={(event) => this.handleChangeinput(event, 'fullName')} />
                                    </div>
                                    <div className='col-6 form-group'>
                                        <label><FormattedMessage id="patient.booking-modal.phonenumber" /></label>
                                        <input className='form-control' onChange={(event) => this.handleChangeinput(event, 'PhoneNumer')} />
                                    </div>
                                    <div className='col-6 form-group'>
                                        <label><FormattedMessage id="patient.booking-modal.email" /></label>
                                        <input className='form-control' onChange={(event) => this.handleChangeinput(event, 'email')} />
                                    </div>
                                    <div className='col-6 form-group'>
                                        <label><FormattedMessage id="patient.booking-modal.address" /></label>
                                        <input className='form-control' onChange={(event) => this.handleChangeinput(event, 'address')} />
                                    </div>
                                ...
                                <div className='booking-modal-footer'>
                                    <button className='btn-booking-confirm' onClick={() => this.handleComfirmBooking()}><FormattedMessage id="patient.booking-modal.btncomfirm" /></button>
                                    <button className='btn-booking-cancel' onClick={closeBooking}><FormattedMessage id="patient.booking-modal.btncancel" /></button>
                                </div>
                            </div>
                        </div>
                    </Modal>
